...
function GetUploadify_minipro(num,elementid,path,callback, v_source, v_indexs)
{
    ...
    if (num > 0) {
        var width = '85%';
        var height = '85%';
        var upurl = eyou_basefile+'?m=admin&c=Uploadify&a=upload&lang='+__lang__+'&num='+num+'&input='+elementid+'&path='+path+'&func='+callback;
            ...
            new Vue({
                ...
                methods: {
                    ...
                    onSelectArchives: function (item) {
                        ...
                        var uris = {
                            article: eyou_basefile+'?m=admin&c=Minipro&a=ajax_archives_list&assembly=article&aids='+aids+'&lang='+__lang__
                        };
                        $.selectData({
                            title: '选择文档',
                            uri: uris[item.type],
                    ...
                    onSelectGoods: function (item) {
                        ...
                        var uris = {
                            goods: eyou_basefile+'?m=admin&c=Minipro&a=ajax_archives_list&channel=2&assembly=goods&aids='+aids+'&lang='+__lang__
                    ...
                    onRichText: function (item) {
                        ...
                        var $umeditor = UE.getEditor('ume-editor',{
                            serverUrl : eyou_basefile+'?m=admin&c=Ueditor&a=index&savepath=ueditor&lang='+__lang__,
                            zIndex: 999,
