<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:44:"./application/admin/template/index\index.htm";i:1586191213;s:68:"D:\project\eyoucmsDemo\application\admin\template\public\menubox.htm";i:1571728724;s:65:"D:\project\eyoucmsDemo\application\admin\template\public\left.htm";i:1582973980;}*/ ?>
<!doctype html>
<html>
<head>
...
<link rel="shortcut icon" type="image/x-icon" href="/eyoucmsDemo/favicon.ico" media="screen"/>
...
<link href="/eyoucmsDemo/public/static/admin/js/jquery-ui/jquery-ui.min.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript" src="/eyoucmsDemo/public/static/admin/js/common.js?v=<?php echo $version; ?>"></script>
<script type="text/javascript" src="/eyoucmsDemo/public/static/admin/js/jquery-ui/jquery-ui.min.js"></script>
<script type="text/javascript" src="/eyoucmsDemo/public/static/admin/js/jquery.cookie.js"></script>
<script type="text/javascript" src="/eyoucmsDemo/public/static/admin/js/jquery.bgColorSelector.js"></script>
<script type="text/javascript" src="/eyoucmsDemo/public/static/admin/js/admincp.js?v=<?php echo $version; ?>"></script>
<script type="text/javascript" src="/eyoucmsDemo/public/static/admin/js/jquery.validation.min.js"></script>

<!-- <script type="text/javascript" src="/eyoucmsDemo/public/plugins/layer/layer.js"></script> -->
<script type="text/javascript" src="/eyoucmsDemo/public/plugins/layer-v3.1.0/layer.js?v=<?php echo $version; ?>"></script>
<script type="text/javascript" src="/eyoucmsDemo/public/static/admin/js/dialog/dialog.js?v=<?php echo $version; ?>" id="dialog_js"></script>
...
<div class="eycms_cont_left hidden-xs">
    <dl class="eylogo">
        ...
        <a href="<?php echo \think\Request::instance()->url(); ?>"><img id="web_adminlogo" src="/eyoucmsDemo/public/static/admin/images/logo_ey.png?v=<?php echo time(); ?>" alt="点击刷新" title="点击刷新"></a>
        <?php else: ?>
        <a href="<?php echo \think\Request::instance()->url(); ?>"><img id="web_adminlogo" src="/eyoucmsDemo/public/static/admin/images/logo.png?v=<?php echo time(); ?>" alt="点击刷新" title="点击刷新"></a>
        <?php endif; ?>
    </dl>
